...
impl Z80InstructionDecoder {
    ...
    pub fn push(&mut self, byte:u8) -> DecoderState<Z80Instruction> {
        self.decoder.decode(byte)
    }
    ...
    fn register_instructions(&mut self) {
        ...
        // OUT
        self.decoder.register([0xED, 0x79], ZI::Load(ZIL::RegisterIndirectA, ZIL::RegisterA));
        self.decoder.register([0xED, 0x41], ZI::Load(ZIL::RegisterIndirectB, ZIL::RegisterA));
        self.decoder.register([0xED, 0x49], ZI::Load(ZIL::RegisterIndirectC, ZIL::RegisterA));
        self.decoder.register([0xED, 0x51], ZI::Load(ZIL::RegisterIndirectD, ZIL::RegisterA));
        self.decoder.register([0xED, 0x59], ZI::Load(ZIL::RegisterIndirectE, ZIL::RegisterA));
        self.decoder.register([0xED, 0x69], ZI::Load(ZIL::RegisterIndirectH, ZIL::RegisterA));
        self.decoder.register([0xED, 0x61], ZI::Load(ZIL::RegisterIndirectL, ZIL::RegisterA));
