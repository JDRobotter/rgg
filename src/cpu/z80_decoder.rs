...
impl Z80Instruction {
    pub fn to_string(&self) -> String {
        match self {
            ...
            Z80Instruction::JumpImmediate(cond, addr) => {
                format!("jp {} {}", cond.to_string(), addr.to_string())
            }
            ...
            Z80Instruction::Call(cond, addr) => {
                format!("call {} {}", cond.to_string(), addr.to_string())
            }
            ...
            Z80Instruction::Load16(dst, src) => {
                format!("ld16 {} {}", dst.to_string(), src.to_string())
            }
            ...
            Z80Instruction::Add16(dst, src) => {
                format!("add {} {}", dst.to_string(), src.to_string())
            }
            Z80Instruction::AddCarry(src) => format!("adc {}", src.to_string()),
            Z80Instruction::Add16Carry(dst, src) => {
                format!("add {} {}", dst.to_string(), src.to_string())
            }
            Z80Instruction::Sub(src) => format!("sub {}", src.to_string()),
            Z80Instruction::Sub16Carry(dst, src) => {
                format!("sbc {} {}", dst.to_string(), src.to_string())
            }
...
impl Z80InstructionDecoder {
    ...
    fn op_r_to_location(r: u8) -> ZIL {
        match r {
            ...
            0b111 => ZIL::RegisterA,
            _ => {
                panic!("invalid bit operation")
            }
        }
    }

    fn decode_CB_bit_manipulation(
        &self,
        byte: u8,
        oix: Option<Z80InstructionLocation>,
    ) -> Option<Z80Instruction> {
        let op = (byte >> 6) & 0x03;
        let b = (byte >> 3) & 0x07;
    ...
    fn register_instructions(&mut self) {
        ...
        // ADD to HL
        self.decoder
            .register([0x09], ZI::Add16(ZIL::RegisterHL, ZIL::RegisterBC));
        self.decoder
            .register([0x19], ZI::Add16(ZIL::RegisterHL, ZIL::RegisterDE));
        self.decoder
            .register([0x29], ZI::Add16(ZIL::RegisterHL, ZIL::RegisterHL));
        self.decoder
            .register([0x39], ZI::Add16(ZIL::RegisterHL, ZIL::RegisterSP));

        self.decoder
            .register([0xDD, 0x09], ZI::Add16(ZIL::RegisterIX, ZIL::RegisterBC));
        self.decoder
            .register([0xDD, 0x19], ZI::Add16(ZIL::RegisterIX, ZIL::RegisterDE));
        self.decoder
            .register([0xDD, 0x39], ZI::Add16(ZIL::RegisterIX, ZIL::RegisterSP));
        self.decoder
            .register([0xDD, 0x29], ZI::Add16(ZIL::RegisterIX, ZIL::RegisterIX));

        self.decoder
            .register([0xFD, 0x09], ZI::Add16(ZIL::RegisterIY, ZIL::RegisterBC));
        self.decoder
            .register([0xFD, 0x19], ZI::Add16(ZIL::RegisterIY, ZIL::RegisterDE));
        self.decoder
            .register([0xFD, 0x39], ZI::Add16(ZIL::RegisterIY, ZIL::RegisterSP));
        self.decoder
            .register([0xFD, 0x29], ZI::Add16(ZIL::RegisterIY, ZIL::RegisterIY));

        // ADC HL
        self.decoder.register(
            [0xED, 0x4A],
            ZI::Add16Carry(ZIL::RegisterHL, ZIL::RegisterBC),
        );
        self.decoder.register(
            [0xED, 0x5A],
            ZI::Add16Carry(ZIL::RegisterHL, ZIL::RegisterDE),
        );
        self.decoder.register(
            [0xED, 0x6A],
            ZI::Add16Carry(ZIL::RegisterHL, ZIL::RegisterHL),
        );
        self.decoder.register(
            [0xED, 0x7A],
            ZI::Add16Carry(ZIL::RegisterHL, ZIL::RegisterSP),
        );

        // SDC HL
        self.decoder.register(
            [0xED, 0x42],
            ZI::Sub16Carry(ZIL::RegisterHL, ZIL::RegisterBC),
        );
        self.decoder.register(
            [0xED, 0x52],
            ZI::Sub16Carry(ZIL::RegisterHL, ZIL::RegisterDE),
        );
        self.decoder.register(
            [0xED, 0x62],
            ZI::Sub16Carry(ZIL::RegisterHL, ZIL::RegisterHL),
        );
        self.decoder.register(
            [0xED, 0x72],
            ZI::Sub16Carry(ZIL::RegisterHL, ZIL::RegisterSP),
        );

        self.decoder
            .register([0x03], ZI::Increment16(ZIL::RegisterBC));
        self.decoder
            .register([0x13], ZI::Increment16(ZIL::RegisterDE));
        self.decoder
            .register([0x23], ZI::Increment16(ZIL::RegisterHL));
        self.decoder
            .register([0x33], ZI::Increment16(ZIL::RegisterSP));
        self.decoder
            .register([0xDD, 0x23], ZI::Increment16(ZIL::RegisterIX));
        self.decoder
            .register([0xFD, 0x23], ZI::Increment16(ZIL::RegisterIY));

        self.decoder
            .register([0x0B], ZI::Decrement16(ZIL::RegisterBC));
        self.decoder
            .register([0x1B], ZI::Decrement16(ZIL::RegisterDE));
        self.decoder
            .register([0x2B], ZI::Decrement16(ZIL::RegisterHL));
        self.decoder
            .register([0x3B], ZI::Decrement16(ZIL::RegisterSP));
        self.decoder
            .register([0xDD, 0x2B], ZI::Decrement16(ZIL::RegisterIX));
        self.decoder
            .register([0xFD, 0x2B], ZI::Decrement16(ZIL::RegisterIY));

        // Z80 manual table 6 - 8 bit load group
        // destination register A
        self.decoder
            .register([0x7F], ZI::Load(ZIL::RegisterA, ZIL::RegisterA));
        self.decoder
            .register([0x78], ZI::Load(ZIL::RegisterA, ZIL::RegisterB));
        self.decoder
            .register([0x79], ZI::Load(ZIL::RegisterA, ZIL::RegisterC));
        self.decoder
            .register([0x7A], ZI::Load(ZIL::RegisterA, ZIL::RegisterD));
        self.decoder
            .register([0x7B], ZI::Load(ZIL::RegisterA, ZIL::RegisterE));
        self.decoder
            .register([0x7C], ZI::Load(ZIL::RegisterA, ZIL::RegisterH));
        self.decoder
            .register([0x7D], ZI::Load(ZIL::RegisterA, ZIL::RegisterL));
        self.decoder
            .register([0x7E], ZI::Load(ZIL::RegisterA, ZIL::RegisterIndirectHL));
        self.decoder
            .register([0x0A], ZI::Load(ZIL::RegisterA, ZIL::RegisterIndirectBC));
        self.decoder
            .register([0x1A], ZI::Load(ZIL::RegisterA, ZIL::RegisterIndirectDE));

        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x7E, b], ZI::Load(ZIL::RegisterA, ZIL::IndexedIX(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0xFD, 0x7E, b], ZI::Load(ZIL::RegisterA, ZIL::IndexedIY(b)));
        }
        ...
        for b in 0..=0xff {
            self.decoder
                .register([0x3E, b], ZI::Load(ZIL::RegisterA, ZIL::Immediate(b)));
        }

        // destination register B
        self.decoder
            .register([0x47], ZI::Load(ZIL::RegisterB, ZIL::RegisterA));
        self.decoder
            .register([0x40], ZI::Load(ZIL::RegisterB, ZIL::RegisterB));
        self.decoder
            .register([0x41], ZI::Load(ZIL::RegisterB, ZIL::RegisterC));
        self.decoder
            .register([0x42], ZI::Load(ZIL::RegisterB, ZIL::RegisterD));
        self.decoder
            .register([0x43], ZI::Load(ZIL::RegisterB, ZIL::RegisterE));
        self.decoder
            .register([0x44], ZI::Load(ZIL::RegisterB, ZIL::RegisterH));
        self.decoder
            .register([0x45], ZI::Load(ZIL::RegisterB, ZIL::RegisterL));
        self.decoder
            .register([0x46], ZI::Load(ZIL::RegisterB, ZIL::RegisterIndirectHL));

        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x46, b], ZI::Load(ZIL::RegisterB, ZIL::IndexedIX(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0xFD, 0x46, b], ZI::Load(ZIL::RegisterB, ZIL::IndexedIY(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0x06, b], ZI::Load(ZIL::RegisterB, ZIL::Immediate(b)));
        }

        // destination register C
        self.decoder
            .register([0x4F], ZI::Load(ZIL::RegisterC, ZIL::RegisterA));
        self.decoder
            .register([0x48], ZI::Load(ZIL::RegisterC, ZIL::RegisterB));
        self.decoder
            .register([0x49], ZI::Load(ZIL::RegisterC, ZIL::RegisterC));
        self.decoder
            .register([0x4A], ZI::Load(ZIL::RegisterC, ZIL::RegisterD));
        self.decoder
            .register([0x4B], ZI::Load(ZIL::RegisterC, ZIL::RegisterE));
        self.decoder
            .register([0x4C], ZI::Load(ZIL::RegisterC, ZIL::RegisterH));
        self.decoder
            .register([0x4D], ZI::Load(ZIL::RegisterC, ZIL::RegisterL));
        self.decoder
            .register([0x4E], ZI::Load(ZIL::RegisterC, ZIL::RegisterIndirectHL));

        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x4E, b], ZI::Load(ZIL::RegisterC, ZIL::IndexedIX(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0xFD, 0x4E, b], ZI::Load(ZIL::RegisterC, ZIL::IndexedIY(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0x0E, b], ZI::Load(ZIL::RegisterC, ZIL::Immediate(b)));
        }

        // destination register D
        self.decoder
            .register([0x57], ZI::Load(ZIL::RegisterD, ZIL::RegisterA));
        self.decoder
            .register([0x50], ZI::Load(ZIL::RegisterD, ZIL::RegisterB));
        self.decoder
            .register([0x51], ZI::Load(ZIL::RegisterD, ZIL::RegisterC));
        self.decoder
            .register([0x52], ZI::Load(ZIL::RegisterD, ZIL::RegisterD));
        self.decoder
            .register([0x53], ZI::Load(ZIL::RegisterD, ZIL::RegisterE));
        self.decoder
            .register([0x54], ZI::Load(ZIL::RegisterD, ZIL::RegisterH));
        self.decoder
            .register([0x55], ZI::Load(ZIL::RegisterD, ZIL::RegisterL));
        self.decoder
            .register([0x56], ZI::Load(ZIL::RegisterD, ZIL::RegisterIndirectHL));

        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x56, b], ZI::Load(ZIL::RegisterD, ZIL::IndexedIX(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0xFD, 0x56, b], ZI::Load(ZIL::RegisterD, ZIL::IndexedIY(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0x16, b], ZI::Load(ZIL::RegisterD, ZIL::Immediate(b)));
        }

        // destination register E
        self.decoder
            .register([0x5F], ZI::Load(ZIL::RegisterE, ZIL::RegisterA));
        self.decoder
            .register([0x58], ZI::Load(ZIL::RegisterE, ZIL::RegisterB));
        self.decoder
            .register([0x59], ZI::Load(ZIL::RegisterE, ZIL::RegisterC));
        self.decoder
            .register([0x5A], ZI::Load(ZIL::RegisterE, ZIL::RegisterD));
        self.decoder
            .register([0x5B], ZI::Load(ZIL::RegisterE, ZIL::RegisterE));
        self.decoder
            .register([0x5C], ZI::Load(ZIL::RegisterE, ZIL::RegisterH));
        self.decoder
            .register([0x5D], ZI::Load(ZIL::RegisterE, ZIL::RegisterL));
        self.decoder
            .register([0x5E], ZI::Load(ZIL::RegisterE, ZIL::RegisterIndirectHL));

        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x5E, b], ZI::Load(ZIL::RegisterE, ZIL::IndexedIX(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0xFD, 0x5E, b], ZI::Load(ZIL::RegisterE, ZIL::IndexedIY(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0x1E, b], ZI::Load(ZIL::RegisterE, ZIL::Immediate(b)));
        }

        // destination register H
        self.decoder
            .register([0x67], ZI::Load(ZIL::RegisterH, ZIL::RegisterA));
        self.decoder
            .register([0x60], ZI::Load(ZIL::RegisterH, ZIL::RegisterB));
        self.decoder
            .register([0x61], ZI::Load(ZIL::RegisterH, ZIL::RegisterC));
        self.decoder
            .register([0x62], ZI::Load(ZIL::RegisterH, ZIL::RegisterD));
        self.decoder
            .register([0x63], ZI::Load(ZIL::RegisterH, ZIL::RegisterE));
        self.decoder
            .register([0x64], ZI::Load(ZIL::RegisterH, ZIL::RegisterH));
        self.decoder
            .register([0x65], ZI::Load(ZIL::RegisterH, ZIL::RegisterL));
        self.decoder
            .register([0x66], ZI::Load(ZIL::RegisterH, ZIL::RegisterIndirectHL));

        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x66, b], ZI::Load(ZIL::RegisterH, ZIL::IndexedIX(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0xFD, 0x66, b], ZI::Load(ZIL::RegisterH, ZIL::IndexedIY(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0x26, b], ZI::Load(ZIL::RegisterH, ZIL::Immediate(b)));
        }

        // destination register L
        self.decoder
            .register([0x6F], ZI::Load(ZIL::RegisterL, ZIL::RegisterA));
        self.decoder
            .register([0x68], ZI::Load(ZIL::RegisterL, ZIL::RegisterB));
        self.decoder
            .register([0x69], ZI::Load(ZIL::RegisterL, ZIL::RegisterC));
        self.decoder
            .register([0x6A], ZI::Load(ZIL::RegisterL, ZIL::RegisterD));
        self.decoder
            .register([0x6B], ZI::Load(ZIL::RegisterL, ZIL::RegisterE));
        self.decoder
            .register([0x6C], ZI::Load(ZIL::RegisterL, ZIL::RegisterH));
        self.decoder
            .register([0x6D], ZI::Load(ZIL::RegisterL, ZIL::RegisterL));
        self.decoder
            .register([0x6E], ZI::Load(ZIL::RegisterL, ZIL::RegisterIndirectHL));

        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x6E, b], ZI::Load(ZIL::RegisterL, ZIL::IndexedIX(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0xFD, 0x6E, b], ZI::Load(ZIL::RegisterL, ZIL::IndexedIY(b)));
        }
        for b in 0..=0xff {
            self.decoder
                .register([0x2E, b], ZI::Load(ZIL::RegisterL, ZIL::Immediate(b)));
        }
        ...
        self.decoder
            .register([0x77], ZI::Load(ZIL::RegisterIndirectHL, ZIL::RegisterA));
        self.decoder
            .register([0x70], ZI::Load(ZIL::RegisterIndirectHL, ZIL::RegisterB));
        self.decoder
            .register([0x71], ZI::Load(ZIL::RegisterIndirectHL, ZIL::RegisterC));
        self.decoder
            .register([0x72], ZI::Load(ZIL::RegisterIndirectHL, ZIL::RegisterD));
        self.decoder
            .register([0x73], ZI::Load(ZIL::RegisterIndirectHL, ZIL::RegisterE));
        self.decoder
            .register([0x74], ZI::Load(ZIL::RegisterIndirectHL, ZIL::RegisterH));
        self.decoder
            .register([0x75], ZI::Load(ZIL::RegisterIndirectHL, ZIL::RegisterL));

        for b in 0..=0xff {
            self.decoder.register(
                [0x36, b],
                ZI::Load(ZIL::RegisterIndirectHL, ZIL::Immediate(b)),
            );
        }

        // destination register indirect BC
        self.decoder
            .register([0x02], ZI::Load(ZIL::RegisterIndirectBC, ZIL::RegisterA));
        // destination register indirect DE
        self.decoder
            .register([0x12], ZI::Load(ZIL::RegisterIndirectDE, ZIL::RegisterA));

        // destination IX+d
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x77, b], ZI::Load(ZIL::IndexedIX(b), ZIL::RegisterA));
            self.decoder
                .register([0xDD, 0x70, b], ZI::Load(ZIL::IndexedIX(b), ZIL::RegisterB));
            self.decoder
                .register([0xDD, 0x71, b], ZI::Load(ZIL::IndexedIX(b), ZIL::RegisterC));
            self.decoder
                .register([0xDD, 0x72, b], ZI::Load(ZIL::IndexedIX(b), ZIL::RegisterD));
            self.decoder
                .register([0xDD, 0x73, b], ZI::Load(ZIL::IndexedIX(b), ZIL::RegisterE));
            self.decoder
                .register([0xDD, 0x74, b], ZI::Load(ZIL::IndexedIX(b), ZIL::RegisterH));
            self.decoder
                .register([0xDD, 0x75, b], ZI::Load(ZIL::IndexedIX(b), ZIL::RegisterL));
        }

        for (a, b) in iproduct!(0..=0xff, 0..=0xff) {
            self.decoder.register(
                [0xDD, 0x36, a, b],
                ZI::Load(ZIL::IndexedIX(a), ZIL::Immediate(b)),
            );
        }
        ...
        for b in 0..=0xff {
            self.decoder
                .register([0xFD, 0x77, b], ZI::Load(ZIL::IndexedIY(b), ZIL::RegisterA));
            self.decoder
                .register([0xFD, 0x70, b], ZI::Load(ZIL::IndexedIY(b), ZIL::RegisterB));
            self.decoder
                .register([0xFD, 0x71, b], ZI::Load(ZIL::IndexedIY(b), ZIL::RegisterC));
            self.decoder
                .register([0xFD, 0x72, b], ZI::Load(ZIL::IndexedIY(b), ZIL::RegisterD));
            self.decoder
                .register([0xFD, 0x73, b], ZI::Load(ZIL::IndexedIY(b), ZIL::RegisterE));
            self.decoder
                .register([0xFD, 0x74, b], ZI::Load(ZIL::IndexedIY(b), ZIL::RegisterH));
            self.decoder
                .register([0xFD, 0x75, b], ZI::Load(ZIL::IndexedIY(b), ZIL::RegisterL));
        }

        for (a, b) in iproduct!(0..=0xff, 0..=0xff) {
            self.decoder.register(
                [0xFD, 0x36, a, b],
                ZI::Load(ZIL::IndexedIY(a), ZIL::Immediate(b)),
            );
        }

        // register R
        self.decoder
            .register([0xED, 0x5F], ZI::Load(ZIL::RegisterA, ZIL::RegisterR));
        self.decoder
            .register([0xED, 0x4F], ZI::Load(ZIL::RegisterA, ZIL::RegisterE));

        // OUT (C),r p.280
        self.decoder.register(
            [0xED, 0x41],
            ZI::Out(ZIL::RegisterIndirectC, ZIL::RegisterB),
        );
        self.decoder.register(
            [0xED, 0x49],
            ZI::Out(ZIL::RegisterIndirectC, ZIL::RegisterC),
        );
        self.decoder.register(
            [0xED, 0x51],
            ZI::Out(ZIL::RegisterIndirectC, ZIL::RegisterD),
        );
        self.decoder.register(
            [0xED, 0x59],
            ZI::Out(ZIL::RegisterIndirectC, ZIL::RegisterE),
        );
        self.decoder.register(
            [0xED, 0x69],
            ZI::Out(ZIL::RegisterIndirectC, ZIL::RegisterH),
        );
        self.decoder.register(
            [0xED, 0x61],
            ZI::Out(ZIL::RegisterIndirectC, ZIL::RegisterL),
        );
        self.decoder.register(
            [0xED, 0x79],
            ZI::Out(ZIL::RegisterIndirectC, ZIL::RegisterA),
        );
        ...
        self.decoder
            .register([0x08], ZI::Exchange(ZIL::RegisterAF, ZIL::RegisterAFp));
        self.decoder.register([0xD9], ZI::ExchangeX);
        self.decoder
            .register([0xEB], ZI::Exchange(ZIL::RegisterDE, ZIL::RegisterHL));
        self.decoder.register(
            [0xE3],
            ZI::Exchange(ZIL::RegisterIndirectSP, ZIL::RegisterHL),
        );
        self.decoder.register(
            [0xDD, 0xE3],
            ZI::Exchange(ZIL::RegisterIndirectSP, ZIL::RegisterIX),
        );
        self.decoder.register(
            [0xFD, 0xE3],
            ZI::Exchange(ZIL::RegisterIndirectSP, ZIL::RegisterIY),
        );
        ...
        // SP
        self.decoder
            .register([0xF9], ZI::Load16(ZIL::RegisterSP, ZIL::RegisterHL));
        self.decoder
            .register([0xDD, 0xF9], ZI::Load16(ZIL::RegisterSP, ZIL::RegisterIX));
        self.decoder
            .register([0xFD, 0xF9], ZI::Load16(ZIL::RegisterSP, ZIL::RegisterIY));
        for (a, b) in iproduct!(0..=0xff, 0..=0xff) {
            self.decoder.register(
                [0x31, a, b],
        ...
        self.decoder
            .register([0xDD, 0xE5], ZI::Push(ZIL::RegisterIX));
        self.decoder
            .register([0xFD, 0xE5], ZI::Push(ZIL::RegisterIY));
        ...
        self.decoder
            .register([0xDD, 0xE1], ZI::Pop(ZIL::RegisterIX));
        self.decoder
            .register([0xFD, 0xE1], ZI::Pop(ZIL::RegisterIX));
        ...
        self.decoder
            .register([0x86], ZI::Add(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x86, b], ZI::Add(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0x86, b], ZI::Add(ZIL::IndexedIY(b)));
        ...
        self.decoder
            .register([0x8E], ZI::AddCarry(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x8E, b], ZI::AddCarry(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0x8E, b], ZI::AddCarry(ZIL::IndexedIY(b)));
            self.decoder
                .register([0xCE, b], ZI::AddCarry(ZIL::Immediate(b)));
        }
        ...
        self.decoder
            .register([0x96], ZI::Sub(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x96, b], ZI::Sub(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0x96, b], ZI::Sub(ZIL::IndexedIY(b)));
        ...
        self.decoder
            .register([0x9E], ZI::SubCarry(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x9E, b], ZI::SubCarry(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0x9E, b], ZI::SubCarry(ZIL::IndexedIY(b)));
            self.decoder
                .register([0xDE, b], ZI::SubCarry(ZIL::Immediate(b)));
        }
        ...
        self.decoder
            .register([0xA6], ZI::And(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0xA6, b], ZI::And(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0xA6, b], ZI::And(ZIL::IndexedIY(b)));
        ...
        self.decoder
            .register([0xAE], ZI::Xor(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0xAE, b], ZI::Xor(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0xAE, b], ZI::Xor(ZIL::IndexedIY(b)));
        ...
        self.decoder
            .register([0xB6], ZI::Or(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0xB6, b], ZI::Or(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0xB6, b], ZI::Or(ZIL::IndexedIY(b)));
        ...
        self.decoder
            .register([0xBE], ZI::Compare(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0xBE, b], ZI::Compare(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0xBE, b], ZI::Compare(ZIL::IndexedIY(b)));
            self.decoder
                .register([0xFE, b], ZI::Compare(ZIL::Immediate(b)));
        }
        ...
        self.decoder
            .register([0x34], ZI::Increment(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x34, b], ZI::Increment(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0x34, b], ZI::Increment(ZIL::IndexedIY(b)));
        }
        ...
        self.decoder
            .register([0x35], ZI::Decrement(ZIL::RegisterIndirectHL));
        for b in 0..=0xff {
            self.decoder
                .register([0xDD, 0x35, b], ZI::Decrement(ZIL::IndexedIX(b)));
            self.decoder
                .register([0xFD, 0x35, b], ZI::Decrement(ZIL::IndexedIY(b)));
        }
        ...
        self.decoder.register(
            [0xE9],
            ZI::JumpImmediate(ZJC::Unconditionnal, ZIL::RegisterHL),
        );
        self.decoder.register(
            [0xDD, 0xE9],
            ZI::JumpImmediate(ZJC::Unconditionnal, ZIL::RegisterIX),
        );
        self.decoder.register(
            [0xFD, 0xE9],
            ZI::JumpImmediate(ZJC::Unconditionnal, ZIL::RegisterIY),
        );
        ...
        for b in 0..=0xff {
            self.decoder
                .register([0x10, b], ZI::DecrementJumpNZ(ZIL::Immediate(2 + b)));
        }

        // return
        self.decoder
            .register([0xC9], ZI::Return(ZJC::Unconditionnal));
        ...
        for b in 0..=0xff {
            self.decoder
                .register([0xD3, b], ZI::Out(ZIL::Indirect(b), ZIL::RegisterA));
            self.decoder
                .register([0xDB, b], ZI::In(ZIL::RegisterA, ZIL::Indirect(b)));
        }
